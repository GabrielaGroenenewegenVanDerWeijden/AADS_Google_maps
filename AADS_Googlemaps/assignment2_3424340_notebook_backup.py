...
def find_path(coordinate_A, coordinate_B, map_, vehicle_speed, find_at_most=3):
    ...
    for pos_exit in exits:
        print(pos_exit)
        exits_A.append(BFSSolverFastestPath()(Graph(map_), (pos_exit, 0), closest_A[0], vehicle_speed))
        exits_B.append(BFSSolverFastestPath()(Graph(map_), (pos_exit, 0), closest_B[0], vehicle_speed))
